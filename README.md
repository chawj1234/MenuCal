...
1. **앱 실행**: DayOne! 실행 시 상태바 우측에 현재 날짜가 표시됩니다
2. **캘린더 보기**: 상태바의 날짜를 **좌클릭**하면 캘린더 팝오버가 나타납니다
3. **메뉴 접근**: 상태바의 날짜를 **우클릭**하면 About/Quit 메뉴가 나타납니다
4. **날짜 선택**: 캘린더에서 원하는 날짜를 클릭하면 해당 날짜의 날씨 정보를 확인할 수 있습니다
